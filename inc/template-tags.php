 ...
 * @return bool
 */
function iflynepal_has_contact() {
	return is_page_template( 'page-contact-us.php' ) || is_page( 'contact-us' );
}
...
function iflynepal_current_hero_image_url() {
	...
	if ( iflynepal_has_news_story() ) {
		return iflynepal_news_hero_image_url();
	}

	if ( iflynepal_has_news() ) {
	...
	if ( iflynepal_has_authors_archive() ) {
		return iflynepal_authors_hero_image_url();
	}
