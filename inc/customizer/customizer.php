...
require_once IFLYNEPAL_DIR . '/inc/customizer/callbacks/packages.php';
require_once IFLYNEPAL_DIR . '/inc/customizer/callbacks/404.php';
...
function iflynepal_customize_register( WP_Customize_Manager $wp_customize ) {
	...
	require IFLYNEPAL_DIR . '/inc/customizer/sections/packages.php';
	require IFLYNEPAL_DIR . '/inc/customizer/sections/404.php';
}
