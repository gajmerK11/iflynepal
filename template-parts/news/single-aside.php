...
$iflynepal_news_aside_labels = array(
	...
	<div class="aside-card">
		...
		<div class="aside-block">
			...
			<a class="aside-author" href="<?php echo esc_url( get_author_posts_url( $iflynepal_news_aside_author ) ); ?>">
				<?php if ( '' !== $iflynepal_news_aside_initials ) : ?>
					<span class="post-avatar" aria-hidden="true"><?php echo esc_html( $iflynepal_news_aside_initials ); ?></span>
				<?php endif; ?>
				<span><strong><?php echo esc_html( $iflynepal_news_aside_name ); ?></strong><small><?php echo esc_html( iflynepal_article_author_line( $iflynepal_news_aside_author ) ); ?></small></span>
			</a>
		</div>
		...
		<div class="share-row">
			...
			<?php foreach ( $iflynepal_news_aside_socials as $iflynepal_news_aside_key => $iflynepal_news_aside_url ) : ?>
				<a class="icon-btn" href="<?php echo esc_url( $iflynepal_news_aside_url ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( $iflynepal_news_aside_labels[ $iflynepal_news_aside_key ] ); ?>"><?php
					echo $iflynepal_news_aside_icons[ $iflynepal_news_aside_key ]; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Fixed markup declared above.
				?></a>
			<?php endforeach; ?>
		</div>
